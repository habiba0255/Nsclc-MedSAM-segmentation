# Nsclc-MedSAM-segmentation
A Hybrid deep learning model for tumor and pulmonary nodule segmentation in NSCLC using MedSAM
---
...
To address these challenges, we developed a novel hybrid deep learning model that fuses PET/CT and CT modalities for automatic segmentation of lung tumors and pulmonary nodules, built on top of the MedSAM foundation model.
...
- **Total:** 188 ¹⁸F-FDG PET/CT scans of NSCLC patients
  ...
  - 168 cases from the public AutoPET MICCAI 2022 Challenge
  - 20 cases from our institution (CHU Sahloul, Sousse, Tunisia)


- **Annotation:** Manual segmentation of lung tumors and pulmonary nodules using the PET Tumor Segmentation extension in 3D Slicer, confirmed by a nuclear medicine physician
- **Split:**
...
>⚠️ Institutional patient data cannot be shared publicly due to patient privacy regulations. The AutoPET subset is publicly available via the AutoPET Challenge.
...
The full abstract is available in the EANM 2025 Abstract Book (see abstract/ folder).
